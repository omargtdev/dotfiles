...
keys = [
    ...
    Key([mod], "t", lazy.window.toggle_floating(), desc="Toggle fpactl set-sink-mute @DEFAULT_SINK@ toggleloating on the focused window"),
    Key([mod, "control"], "r", lazy.reload_config(), desc="Reload the config"),

    # TODO: Show a list of options to exec instead of shutdown only
    ...
    # TODO: Create script to avoid overriding 100% volume
    ...
    Key([], "XF86AudioMute", lazy.spawn("pactl set-sink-mute @DEFAULT_SINK@ toggle"), desc="Toggle mute output"),
    Key([], "XF86AudioMicMute", lazy.spawn("pactl set-source-mute @DEFAULT_SOURCE@ toggle"), desc="Toggle mute input"),
